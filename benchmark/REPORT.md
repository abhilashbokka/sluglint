...
| `C014` | open a flashback and never close it | 5 | 5 | 100% | 100% | none |
| `C019` | abbreviate a location in one heading | 2 | 1 | 50% | 100% | `C005` x2 |
| `F002` | strip the time of day off one heading | 6 | 6 | 100% | 100% | none |
| `F003` | leave a character cue with nothing under it | 6 | 6 | 100% | 100% | none |
| `F004` | grow an action block into a wall of text | 6 | 6 | 100% | 100% | `C007` x2 |
| `F005` | add a camera direction | 6 | 6 | 100% | 100% | none |
| `F019` | cue the same character twice in a row | 6 | 6 | 100% | 100% | none |
| `F025` | leave a pagination artifact behind | 6 | 5 | 83% | 83% | none |
| `F027` | introduce word-processor typography | 6 | 6 | 100% | 100% | none |
...
|---|---:|
| abbreviate_location | 4 |
| day_night_whiplash | 6 |
| split_location | 3 |
